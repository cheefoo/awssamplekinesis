...
public class SimulationKinesisAppRP    implements IRecordProcessor
{
    ...
    private void processRecordsWithRetries(List<Record> records) {
        for (Record record : records) {
            ...
            for (int i = 0; i < NUM_RETRIES; i++) {
                try {
                    //
                    // Simulating JDBC open connection
                    //
    ...
    private void processSingleRecord(Record record) {
        ...
        try
        {
            ...
            int sleepTime = 2000 + new Random().nextInt(1000);
            Thread.sleep(sleepTime);   // Simulating increasing IteratorAge. Milliseconds
            LOG.info("Processing Slept for  for " + sleepTime);
        }
